...
Public Class DataBaseAccess
    ...
    Private ConnectionString As String = "workstation id=QuanLyBanHangPS03748.mssql.somee.com;packet size=4096;user id=minhltps03748_SQLLogin_2;pwd=7z19ywytg2;data source=QuanLyBanHangPS03748.mssql.somee.com;persist security info=False;initial catalog=QuanLyBanHangPS03748"
    ...
    Public Function OpenConnection() As Boolean
        Try ' open connection
            If SqlCon.State <> ConnectionState.Open Then
                SqlCon.ConnectionString = "workstation id=QuanLyBanHangPS03748.mssql.somee.com;packet size=4096;user id=minhltps03748_SQLLogin_2;pwd=7z19ywytg2;data source=QuanLyBanHangPS03748.mssql.somee.com;persist security info=False;initial catalog=QuanLyBanHangPS03748"
                SqlCon.Open()
                Return True
            Else
                Return False
